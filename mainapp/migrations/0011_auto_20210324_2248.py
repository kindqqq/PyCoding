...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0010_auto_20210323_1611'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обрадотке'), ('is_ready', 'Статус готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус заказа')),
