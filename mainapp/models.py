...
class Cart(models.Model):
    ...
    final_price = models.DecimalField(max_digits=9, default=0, decimal_places=2, verbose_name='Конечная Соимость')
...
class Order(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        (STATUS_IN_PROGRESS, 'Заказ в обрадотке'),
    ...
    created_add = models.DateTimeField(auto_now=True, verbose_name='Дата создания')
